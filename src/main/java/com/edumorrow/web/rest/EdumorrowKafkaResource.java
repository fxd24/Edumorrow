...
@RestController
@RequestMapping("/api/edumorrow-kafka")
public class EdumorrowKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EdumorrowKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EdumorrowKafkaResource(KafkaProperties kafkaProperties) {
